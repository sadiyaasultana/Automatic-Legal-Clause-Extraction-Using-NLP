...
if os.path.exists("trained_model"):
    ...
    # Step 2: Add text classification pipeline
    textcat = nlp.add_pipe("textcat")
    textcat.add_label("LegalClause")
    textcat.add_label("CrimeClause")

    # Step 3: Example training data (replace with your data)
    train_data = [
        ("This case falls under IPC 420 for cheating", {"cats": {"LegalClause": 0, "CrimeClause": 1}}),
        ("Agreement between both parties is valid", {"cats": {"LegalClause": 1, "CrimeClause": 0}}),
        ("Breach of contract terms and conditions", {"cats": {"LegalClause": 1, "CrimeClause": 0}}),
        ("Murder under section 302", {"cats": {"LegalClause": 0, "CrimeClause": 1}}),
    ]

    # Step 4: Train model for few iterations
...
# Step 6: Use model for prediction
